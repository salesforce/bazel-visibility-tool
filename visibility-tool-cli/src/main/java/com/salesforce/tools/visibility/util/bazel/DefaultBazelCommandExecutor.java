...
import com.salesforce.tools.visibility.util.SystemUtil;
import com.salesforce.tools.visibility.util.shell.ShellUtil;
...
public class DefaultBazelCommandExecutor implements BazelCommandExecutor {
    ...
    public static class PreparedCommandLine {
        private final List<String> fullCommandLineWithOptionalShellWrappingAndBinary;
        private final List<String> commandLineForDisplayPurposes;

        public PreparedCommandLine(List<String> fullCommandLineWithOptionalShellWrappingAndBinary,
                List<String> commandLineForDisplayPurposes) {
            this.fullCommandLineWithOptionalShellWrappingAndBinary = fullCommandLineWithOptionalShellWrappingAndBinary;
            this.commandLineForDisplayPurposes = commandLineForDisplayPurposes;
        }

        public List<String> commandLineForDisplayPurposes() {
            return commandLineForDisplayPurposes;
        }

        public List<String> fullCommandLineWithOptionalShellWrappingAndBinary() {
            return fullCommandLineWithOptionalShellWrappingAndBinary;
        }
    }
    ...
    protected static void waitForPipeToFinish(
            Thread pipe,
            CancelationCallback cancelationCallback) throws IOException, InterruptedException {
        var delay = 0L;
        var sleepTime = 100L;
    ...
    protected <R> R doExecuteProcess(
            BazelCommand<R> command,
        ...
        try (var streamProvider = newProcessStreamProvider(command, commandLine)) {
            ...
            throw new IllegalStateException("Aborted waiting for result");
        }
    ...
    protected String getToolTagArgument() {
        ...
        return this.cachedToolTagArgument = "--tool_tag=bazel_visibility_tool";
    }
